...
// NOTE: Taken from
// https://github.com/Polymer/lit-element/blob/master/custom_typings/polymer.d.ts
// to make tsc happy. We should not need this after
// https://github.com/Polymer/lit-element/issues/47 is completely resolved.
...
declare module '@polymer/polymer/lib/mixins/properties-changed.js' {
  /**
...
declare module '@polymer/polymer/lib/mixins/properties-mixin.js' {
...
declare module '@polymer/polymer/lib/utils/case-map.js' {
