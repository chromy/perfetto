...
//import {SettingsForTesting as Settings, SettingsStorage} from './settings';
//
...
//test('create setting', () => {
//  const settings = new Settings(new TestSettingsStorage());
//  const mySetting = settings.register({
//    id: 'mySetting',
//    defaultValue: false,
//    description: '',
//  });
//  expect(mySetting.get()).toEqual(false);
//  expect(mySetting.isOverridden()).toEqual(false);
//});
