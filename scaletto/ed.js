var ed = (() => {
  ...
  // node_modules/.pnpm/@codemirror+view@6.17.0/node_modules/@codemirror/view/dist/index.js
  ...
  // node_modules/.pnpm/@codemirror+autocomplete@6.8.1_@codemirror+language@6.9.0_@codemirror+state@6.2.1_@codemirror_z2khzk3mie4rqcxj3tuah33kvi/node_modules/@codemirror/autocomplete/dist/index.js
      ...
      if (onExecute) {
        keymaps.push({
          ...
          run: (view) => {
            ...
            if (!selection2.main.empty) {
              let selectedText = "";
              for (const r of selection2.ranges) {
